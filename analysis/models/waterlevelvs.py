...
X_train, X_test, y_train, y_test = train_test_split(
    parameter[5], parameter[0].ravel(), test_size=0.25)
regressor = DecisionTreeRegressor(random_state=0)
regressor.fit(X_train, y_train)
y_pred = regressor.predict(X_test)
print("Root Mean Squared Error:", mean_squared_error(y_test, y_pred))
nm = labels[5]+"vs"+labels[0]+".joblib"
joblib.dump(regressor, nm)

# sunlight vs ph
print(labels[5], " VS ", labels[1])
X_train, X_test, y_train, y_test = train_test_split(
    parameter[5], parameter[1].ravel(), test_size=0.25)
regressor = DecisionTreeRegressor(random_state=0)
regressor.fit(X_train, y_train)
y_pred = regressor.predict(X_test)
print("Root Mean Squared Error:", mean_squared_error(y_test, y_pred))
nm = labels[5]+"vs"+labels[1]+".joblib"
joblib.dump(regressor, nm)

# sunlight vs ph
print(labels[5], " VS ", labels[2])
X_train, X_test, y_train, y_test = train_test_split(
    parameter[5], parameter[2].ravel(), test_size=0.25)
regressor = DecisionTreeRegressor(random_state=0)
regressor.fit(X_train, y_train)
y_pred = regressor.predict(X_test)
print("Root Mean Squared Error:", mean_squared_error(y_test, y_pred))
nm = labels[5]+"vs"+labels[2]+".joblib"
joblib.dump(regressor, nm)

# sunlight vs ph
print(labels[5], " VS ", labels[3])
X_train, X_test, y_train, y_test = train_test_split(
    parameter[5], parameter[3].ravel(), test_size=0.25)
regressor = DecisionTreeRegressor(random_state=0)
regressor.fit(X_train, y_train)
y_pred = regressor.predict(X_test)
print("Root Mean Squared Error:", mean_squared_error(y_test, y_pred))
nm = labels[5]+"vs"+labels[3]+".joblib"
joblib.dump(regressor, nm)

# sunlight vs ph
print(labels[5], " VS ", labels[4])
X_train, X_test, y_train, y_test = train_test_split(
    parameter[5], parameter[4].ravel(), test_size=0.25)
regressor = DecisionTreeRegressor(random_state=0)
regressor.fit(X_train, y_train)
y_pred = regressor.predict(X_test)
print("Root Mean Squared Error:", mean_squared_error(y_test, y_pred))
nm = labels[5]+"vs"+labels[4]+".joblib"
joblib.dump(regressor, nm)
