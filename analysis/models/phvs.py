...
y_pred = regressor.predict(X_test)
print("Root Mean Squared Error:", mean_squared_error(y_test, y_pred))
nm = labels[0]+"vs"+labels[2]+".joblib"
joblib.dump(regressor, nm)
...
y_pred = regressor.predict(X_test)
print("Root Mean Squared Error:", mean_squared_error(y_test, y_pred))
nm = labels[0]+"vs"+labels[3]+".joblib"
joblib.dump(regressor, nm)
...
y_pred = regressor.predict(X_test)
print("Root Mean Squared Error:", mean_squared_error(y_test, y_pred))
nm = labels[0]+"vs"+labels[4]+".joblib"
joblib.dump(regressor, nm)
...
y_pred = regressor.predict(X_test)
print("Root Mean Squared Error:", mean_squared_error(y_test, y_pred))
nm = labels[0]+"vs"+labels[5]+".joblib"
joblib.dump(regressor, nm)
